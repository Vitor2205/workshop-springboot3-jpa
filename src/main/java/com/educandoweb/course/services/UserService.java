...
public class UserService {
	...
	@Autowired
	private UserRepository repository; // Injete o UserRepository

	public List<User> findAll() { // Altere o tipo de retorno para List<User>
		return repository.findAll(); // Chame o método findAll do UserRepository
	}

	public User findById(Long id) { // Altere o tipo de retorno para User
		Optional<User> obj = repository.findById(id); // Chame o método findById do UserRepository
...
//sendo permitido atualizar apenas essas informações
